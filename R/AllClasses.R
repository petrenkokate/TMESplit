...
#' @slot H_fractions Named list of per-group H matrices
#'   (`n_patients_g x (k_shared + k_specific_g)`); each row sums to 1
#'   (soft assignment). Shared programs occupy the first `k_shared` columns.
